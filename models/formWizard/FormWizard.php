 ...
 */
namespace app\models\formWizard;
...
use yii\bootstrap5\ActiveForm as BS4ActiveForm;
...
class FormWizard extends Widget
{
    ...
    public function getPluginOptions()
    {
        return [
            ...
            'toolbarSettings' => [
                ...
                'toolbarExtraButtons1' => $this->toolbarExtraButtons1,
            ],
            'anchorSettings' => [
    ...
    public function run()
    {
        ...
        }).concat({$pluginOptions['toolbarSettings']['toolbarExtraButtons']}).concat({$pluginOptions['toolbarSettings']['toolbarExtraButtons1']})
JS;
        ...
        $pluginOptions['toolbarSettings']['toolbarExtraButtons1'] = new JsExpression($jsButton);
    ...
    public function createBody($index, $formInfoText, array $step)
    {
        ...
        $html .= Html::tag('div', $formInfoText, ['class' => 'pb-2']);
    ...
    public function registerScripts(array $pluginOptions, $jsOptionsPersistence)
    {
        ...
        $('.fields_container > div').addClass('form-floating mb-3');
        $('.field-installmentform-birthdaypartner').removeClass('form-floating');
        $('.field-installmentform-passportphoto1').removeClass('form-floating');
        $('.field-installmentform-passportphoto2').removeClass('form-floating');
        $('.field-installmentform-passportphoto3').removeClass('form-floating');
        $('.field-installmentform-passportphoto4').removeClass('form-floating');
JS;
        //register script
