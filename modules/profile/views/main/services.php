...
<div class="toolbar">
    <?= Html::a('Добавить', '/profile/service/create', ['class' => 'btn btn-success mb-2']) ?>
</div>
...
</svg>', \yii\helpers\Url::to(['/profile/service/edit', 'id' => $product->id])) ?>
...
</svg>', \yii\helpers\Url::to(['/profile/service/delete', 'id' => $product->id])) ?>
